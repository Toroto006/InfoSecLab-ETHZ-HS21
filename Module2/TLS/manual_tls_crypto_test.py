...
test = Tests()
test.test_tls_transcript_hash()
print("TLS transcript hash passed")

test.test_tls_hkdf_lbl()
print("tls_hkdf_lbl passed")

test.test_tls_derive_key_iv()
print("derive key iv passed")

test.test_tls_extract_secret()
print("extract secret passed")

test.test_tls_derive_secret()
print("derive secret passed")

test.test_tls_finished_key()
print("finished key passed")

test.test_tls_finished_mac()
print("finished mac passed")
test.test_tls_finished_mac_vfy()
print("finished mac fvy passed")

test.test_tls_nonce()
print("tls nonce passed")

test.test_tls_aead_encrypt()
print("aead encrypt passed")

test.test_tls_aead_decrypt()
print("aead decrypt passed")


test.test_tls_sig_context()
print("sig context passed")

test.test_tls_signature()
print("tls signature passed")

test.test_tls_verify_signature()
print("tls verify sig passed")
